...
namespace App\Console\Suppliers\MotherTemp;
...
abstract class BaseMotherTempCommand extends Command
{
	...
	public const LOCK_NOVIKO_STOCK_CHANGES = 'lock_noviko_stock_changes';

	protected static $defaultName = 'suppliers:mothertemp';
